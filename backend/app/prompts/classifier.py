...
CLASSIFIER_LANG_HINT = {
    "ko": "",
    "en": (
        "\n\n[참고] 입력은 영어입니다. 분류 기준은 동일하게 적용하되 "
        "영어권 문화와 표현에 맞게 판단하세요."
    ),
    "zh": (
        "\n\n[参考] 用户输入是中文。分类标准相同，但请根据中文表达习惯和文化背景来判断。"
    ),
    "ja": (
        "\n\n[参考] 入力は日本語です。分類基準は同じように適用しますが、"
        "日本語の表現や文化背景に合わせて判断してください。"
    ),
}
